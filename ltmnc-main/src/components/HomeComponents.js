                ...
                <div className="tool">
                    <div className="tool__workarea" id="workArea">
                        ...
                        <div className="tool__header">
                            ...
                            <h2 className="tool__header__subtitle">Convert JPG images to PDF in seconds. Easily adjust orientation and margins.</h2>
                        </div>
                        ...
                        <div className='img-show'>
                            {
                                image ? image.map(e => {
                                    return (
                                        <img src={e} className='img-show-i' />
                                    )
                                }) : ''
                            }
                        </div>
                        <div id="uploader" className="uploader" >
                            <a className="uploader__btn tooltip--left" id="pickfiles" href="/" title="Add more files">
                                ...
                                <span><Uploder setImage={setImage} setFile={setFile} /> </span>

                            </a>

                            <div className="uploader__extra">
                                <a className="btn-icon uploader__extra__btn tooltip tooltip--right" id="uploadDisk" href="javascript:;"
                            ...
                            <div className="uploader__droptxt">or drop JPG images here</div>
                        </div>
                        <a className="uploader__btn tooltip--left" onClick={UploadImage} > Send</a>
